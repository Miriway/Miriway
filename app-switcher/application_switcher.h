...
#ifndef MIRIWAY_APPLICATION_SWITCHER_H
#define MIRIWAY_APPLICATION_SWITCHER_H
...
/// This class encapsulates the standard usage of the #ApplicationSwitcher.
///
...
/// - Call #ApplicationSwitcher::next_app on `alt + tab`.
/// - Call #ApplicationSwitcher::prev_app on `alt + shift + tab`
/// - Call #ApplicationSwitcher::next_window on `alt + grave`
/// - Call #ApplicationSwitcher::prev_window on `alt + shift + grave`.
///
